...
frutas.shift();
console.log(frutas);
frutas.splice(1, 1); //borra naranja
frutas.splice(1, 0, 'kiwi'); //agrega kiwi en el indice 1
console.log(frutas);
...
/*Pregunta 14:
Problema:
Escribe una función llamada obtenerNombresConLetraA que tome un arreglo de nombres de personas y devuelva un nuevo arreglo que contenga únicamente los nombres 
que comienzan con la letra "A" o "a".
...
function obtenerNombresConLetraA(nombres){
  return nombres.filter(nombre => nombre[0].toUpperCase() == 'A');
}

const nuevoArreglo = obtenerNombresConLetraA(nombres);
